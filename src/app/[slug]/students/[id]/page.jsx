    ...
    printWindow.document.write(`<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"/>
      ...
      <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .notes{background:#f8fafc;border:1px solid #e2e8f0;border-left:3px solid #2563eb;border-radius:6px;padding:10px 14px;font-size:11.5px;color:#475569;margin-bottom:22px}
      ...
      <div class="info-grid">
        <div class="info-box">
          ...
          <div class="ibox-name">${student.full_name}</div>
          ...
          <div class="ibox-row"><span>Permis</span><span>Catégorie ${student.license_type}</span></div>
        </div>
        <div class="info-box">
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td><div class="desc-main">Formation à la conduite – Permis ${student.license_type}</div><div class="desc-sub">${schoolName}</div></td>
            <td>Catégorie ${student.license_type}</td>
            <td>1</td>
